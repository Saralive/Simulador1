...
if __name__ == "__main__":
	...
	for i in range(1,len(experiment.graph)+1):
		...
		m = ComplexNetwork(main,config.ENLACES_DINAMICOS,main.nodosTotales/config.DIV_CONEXIONES,config.EXPLORADORES,config.ROUTING,config.REGLA, config.VECTOR_POPULARIDAD,config.VECTOR_DISTANCIA,config.ALFA)
